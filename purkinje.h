...
private:
	...
	bool stimulated;		// Controlador se uma variavel se encontra estimualda 
...
// Inline
	...
	void setStimulated (bool stim) { this->stimulated = stim; }
	int getId () { return (id); }
	...
	bool getStimulated () { return (stimulated); }
